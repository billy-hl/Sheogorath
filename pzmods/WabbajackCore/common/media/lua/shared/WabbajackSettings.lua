...
change: arming a base raid is an action, and belongs on the menu; "how long is
the raid protection grace" is configuration, and belongs where the rest of this
server's configuration is.
...
and the foliage pass reads settings from a genuinely hot loop.
...
local FIELDS = {
    ...
    ["baseraid.nightChance"]    = { field = "BaseRaidNightChance",     fallback = 33 },
    ["baseraid.nightHourEarliest"] = { field = "BaseRaidNightHourEarliest", fallback = 20 },
    ["baseraid.nightHourLatest"]   = { field = "BaseRaidNightHourLatest",   fallback = 23 },
    ["baseraid.autoPerPlayer"]  = { field = "BaseRaidAutoPerPlayer",   fallback = 40 },
    ["crowns.idleDays"]         = { field = "WabbajackCrownsIdleDays", fallback = 7 },
