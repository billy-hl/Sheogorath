 ...
 *
 * All figures come from the PerkLog (see services/zomboid/leaderboard.js).
 * Skill boards only count *living* characters, because skills reset on death and
 * the newest dump for a dead player describes the character they just lost.
 * Survival and death counts are all-time and include the fallen.
 */
...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('leaderboard')
    .setDescription('Project Zomboid server records — skills, survival and deaths')
    .addStringOption((o) =>
      o
        .setName('board')
  ...
  async execute(interaction) {
    ...
    if (wanted) {
      ...
      switch (interaction.options.getString('board')) {
        case 'champions':
